        ...
        <div class="container py-5">
            <div class="row h-100 align-items-center py-5">
                <div class="col-lg-6">
                    ...
                    <p class="lead text-muted mb-0">Web Page is developed for comucination</p>
                    <p class="lead text-muted">Developed by <a href="https://www.instagram.com/gbarbakadz/" class="text-muted">
                            <u> Giorgi Barbakadze</u></a>
                    </p>
                </div>
        ...
        <div class="container py-5">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 order-2 order-lg-1"><i class="fa fa-bar-chart fa-2x mb-3 text-primary"></i>
                    <h2 class="font-weight-light">Whats your name Amanda ?</h2>
                    <p class="font-italic text-muted mb-4">- Actually my name is amanda</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
                    <h2 class="font-weight-light">Give me your Password</h2>
                    <p class="font-italic text-muted mb-4">- No thanks</p><a href="#" class="btn btn-light px-5 rounded-pill shadow-sm">Learn More</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row mb-4">
                <div class="col-lg-5">
                    ...
                    <p class="font-italic text-muted">Proud with them</p>
                </div>
            </div>
